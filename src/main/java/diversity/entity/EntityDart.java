...
public class EntityDart extends Entity implements IProjectile {
    ...
    public void setThrowableHeading(double p_70186_1_, double p_70186_3_, double p_70186_5_, float p_70186_7_, float p_70186_8_) {
        ...
        this.prevRotationPitch = this.rotationPitch = (float)(Math.atan2(p_70186_3_, (double)f3) * 180.0D / 3.141592653589793D);
    ...
    public void setVelocity(double p_70016_1_, double p_70016_3_, double p_70016_5_) {
        ...
        if (this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
            ...
            this.prevRotationPitch = this.rotationPitch = (float)(Math.atan2(p_70016_3_, (double)f) * 180.0D / 3.141592653589793D);
                ...
                if (movingobjectposition.entityHit != null) {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)k)) {
                        if (movingobjectposition.entityHit instanceof EntityLivingBase) {
                            ...
                            entitylivingbase.addPotionEffect(new PotionEffect(Potion.poison.id, 150 + this.rand.nextInt(100)));
