...
public class EntityApache extends EntityGlobalVillager implements IRangedAttackMob
{
    ...
    public EntityApache(final World world) {
        this(world, EnumTribe.APACHE.getRandomVillager());
    }
    
    public EntityApache(final World world, final EnumVillager type) {
        super(world, type);
    ...
    public EntityVillager createChild(final EntityAgeable p_90011_1_) {
        final EntityGlobalVillager entityvillager = new EntityApache(this.worldObj);
    ...
    protected boolean canAskForHelp() {
        return this.getProfession() == EnumVillager.APACHE_CHIEF.profession;
    }
    
    @Override
    public boolean canDefend() {
        return this.getProfession() == EnumVillager.APACHE_WARRIOR.profession;
    }
